...
pzaTOPIC_PUSHBUTTON=f"pza/lab_paul/io_pza_controling/testing_of_io_controling{17}"
...
d17 = Dio(addr=BROKER_ADDR, port=BROKER_PORT, topic=pzaTOPIC_PUSHBUTTON, client=pzaClient)
...
while True:
    try:
        ...
        print(f" value of the push button {d17.state.active.get()}")
        time.sleep(1)
